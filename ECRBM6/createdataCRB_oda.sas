...
*************************************************************/
%let path=/home/&sysuserid/ECRBM6;
...
%macro unpack(unzip /* Full path pointing to where to create the ECRBM6 data */
...
%let url=%str(http://dl.liveweb.sas.com/eldata/crbm6_oda.zip);
...
%unpack(%superq(path),ECRBM6.zip,ECRBM6)

/* added to set &path for elearning */
%let path=/home/&sysuserid/ECRBM6/data;
